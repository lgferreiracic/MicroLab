...
Bem-vindo ao projeto de e-commerce de produtos 3D! Este projeto foi desenvolvido utilizando [Vite](https://vitejs.dev/), [Vue 3](https://vuejs.org/) e [Supabase](https://supabase.com/) para proporcionar uma experiência moderna, rápida e escalável.
